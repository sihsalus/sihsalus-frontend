...
import { useOdontogramContext } from '../providers/odontogram-provider';
import MainSectionOnTheCanvas from './main-section-on-the-canvas';
import SpaceBetweenLegends from './spacing/space-between-legends';
import SpaceBetweenTeeth from './spacing/space-between-teeth';
import SpacingFinding from './spacing/spacing-finding';
import ToothColumn from './tooth-column';
import ToothDetails from './tooth-details';
import ToothVisualization from './tooth-visualization';
