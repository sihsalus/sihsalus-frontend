...
const getSpaBasePath = () =>
  trimTrailingSlash(
    globalThis.getOpenmrsSpaBase?.() ?? globalThis.spaBase ?? "/openmrs/spa",
  );
...
export const getStartOfDay = () =>
  dayjs().tz(timeZone).startOf("day").toISOString();
...
export const serviceQueuesPatientSearchWorkspace =
  "queue-patient-search-add-to-queue-workspace";
export const serviceQueuesStartVisitWorkspace =
  "queue-patient-search-start-visit-workspace";
export const serviceQueuesCompanionPersonSearchWorkspace =
  "queue-visit-companion-search-workspace";
export const serviceQueuesCompanionPersonRegistrationWorkspace =
  "queue-visit-companion-registration-workspace";
export const serviceQueuesVisitNotesWorkspace =
  "service-queues-visit-notes-workspace";
export const serviceQueuesPatientVitalsWorkspace =
...
export const QUEUE_ENTRY_ALREADY_ENDED_ERROR =
  "queue entry that has already ended";
