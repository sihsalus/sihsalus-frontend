...
import { reconcileEncounterDiagnoses, reconcileObservation } from './visit-note-submission';
...
test('clearing a field voids its canonical and explicit legacy aliases only', () => {
  ...
  expect(reconcileObservation(existing, 'new-question', '', undefined, [{ conceptUuid: 'old-question' }])).toEqual([
