...
import { launchWorkspace2, userHasAccess, useConfig, usePatient, useSession, type Visit } from '@openmrs/esm-framework';
...
const Vitals: React.FC<VitalsComponentProps> = ({ vitals = [], patientUuid, visitType, visit }) => {
  ...
  const canEdit = userHasAccess(vitalsEditPrivilege, session?.user);
