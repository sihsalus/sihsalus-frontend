...
```sh
yarn playwright test -c e2e/stock-management/playwright.config.ts --headed
```
...
```sh
yarn playwright test -c e2e/stock-management/playwright.config.ts --headed -g "title of the test"
```
