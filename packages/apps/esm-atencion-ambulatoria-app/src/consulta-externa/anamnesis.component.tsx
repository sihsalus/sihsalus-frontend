...
const Anamnesis: React.FC<AnamnesisProps> = ({ patientUuid }) => {
  ...
  const handleLaunchForm = useConsultaExternaFormLauncher({
    patientUuid,
    formIdentifier:
      config.formsList?.anamnesisForm ?? config.formsList?.consultaExternaForm,
        ...
        {anamnesisEntries.map((entry) => (
          ...
          >
            ...
            <div className={styles.soapSection}>
              ...
              <p>
                <strong>{t("onsetType", "Forma de inicio")}:</strong>{" "}
                {entry.onsetType || t("noData", "Sin datos")}
              </p>
              <p>
                <strong>{t("course", "Curso")}:</strong>{" "}
                {entry.course || t("noData", "Sin datos")}
              </p>
            ...
            <div className={styles.soapSection}>
              ...
              {entry.biologicalFunctionsSummary ? (
                <p>{entry.biologicalFunctionsSummary}</p>
              ) : null}
              <p>
              ...
              <p>
                <strong>{t("thirst", "Sed")}:</strong>{" "}
                {entry.biologicalFunctions.thirst || t("noData", "Sin datos")}
              </p>
              <p>
                <strong>{t("sleep", "Sueño")}:</strong>{" "}
                {entry.biologicalFunctions.sleep || t("noData", "Sin datos")}
              </p>
              <p>
              ...
              <p>
                <strong>{t("urine", "Orina")}:</strong>{" "}
                {entry.biologicalFunctions.urine || t("noData", "Sin datos")}
              </p>
              <p>
                <strong>{t("bowelMovements", "Deposiciones")}:</strong>{" "}
                {entry.biologicalFunctions.bowelMovements ||
                  t("noData", "Sin datos")}
              </p>
            </div>
          </AccordionItem>
