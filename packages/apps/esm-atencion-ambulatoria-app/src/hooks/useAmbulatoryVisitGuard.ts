...
export function useAmbulatoryVisitGuard({
  ...
  const requireAmbulatoryVisit = useCallback((): VerifiedAmbulatoryVisit | null => {
    ...
    if (
      ...
      showVisitError(
        t('ambulatoryVisitRequired', 'An active Outpatient Care visit is required to record this information.'),
      );
      return null;
    }
