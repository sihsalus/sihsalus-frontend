...
vi.mock('../group-search/compact-group-search', () => ({
  __esModule: true,
  default: ({ selectGroupAction }) => (
    <button type="button" data-testid="compact-group-search" onClick={() => selectGroupAction(selectedGroup)}>
      Select group
    </button>
  ),
}));

vi.mock('../../add-group-modal/add-group-modal', () => ({
  __esModule: true,
