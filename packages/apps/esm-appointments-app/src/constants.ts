...
export const patientIdentityPrintModal = 'print-patient-identity-modal';
export const patientIdentityPrintPrivilege = 'App: Can generate a Patient Identity Sticker';
