...
import { setTaskStatusCompleted, type Task, useTaskList } from './task-list.resource';
...
describe('TaskListView', () => {
  ...
  it('toggles task completion via checkbox', async () => {
    ...
    mockSetTaskStatusCompleted.mockResolvedValue({} as Awaited<ReturnType<typeof setTaskStatusCompleted>>);
