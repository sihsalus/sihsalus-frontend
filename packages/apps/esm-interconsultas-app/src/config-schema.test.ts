...
describe('interconsultas configuration defaults', () => {
  it('uses the SIHSALUS service catalog by default', () => {
    ...
    // El duplicado legado de la cola de consulta externa no debe volver a
    // aparecer como destino de interconsulta (verificado contra produccion).
    expect(configSchema.excludedDestinationConceptUuids._default).toContain('7ba3aa21-cc56-47ca-bb4d-a60549f666c0');
