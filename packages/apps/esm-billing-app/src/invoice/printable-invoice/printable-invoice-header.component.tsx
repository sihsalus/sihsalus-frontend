...
const PrintableInvoiceHeader: React.FC<PrintableInvoiceHeaderProps> = ({ patientDetails, defaultFacility, bill }) => {
  ...
  const patientInformation = {
    [t('name', 'Name')]: patientDetails?.name,
    ...(patientDetails.gender && { [t('gender', 'Gender')]: patientDetails.gender }),
  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.invoiceHeading}>{t('invoice', 'Invoice')}</h1>

      <div className={styles.printableBody}>
        <div className={styles.detailsContainer}>
          <div>
            <h2 className={styles.sectionHeading}>{t('patientInformation', 'Patient information')}</h2>
