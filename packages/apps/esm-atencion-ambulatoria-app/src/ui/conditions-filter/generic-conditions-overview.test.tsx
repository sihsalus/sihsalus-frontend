import { launchWorkspace, showModal, useConfig, userHasAccess } from '@openmrs/esm-framework';
...
it('targets the visible page two record and recovers after deletion refresh', async () => {
  ...
  try {
    ...
    expect(launchWorkspace).toHaveBeenLastCalledWith(
      'conditions-filter-form-workspace',
    ...
    expect(showModal).toHaveBeenLastCalledWith(
      'ambulatoria-condition-delete-confirmation-dialog',
