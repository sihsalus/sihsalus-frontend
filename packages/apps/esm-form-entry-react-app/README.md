...
- Las ediciones fallan de forma cerrada si la atención indicada no puede cargarse: se muestra un error genérico y no se
  habilita el guardado ni se crea una atención nueva como alternativa.
