...
// t('wards', 'Wards')
// t('Hospitalization', 'Hospitalization')
...
export const wardPatientActionButtonExtension = wardPatientActionButton;
...
export const wardPatientNotesActionButtonExtension = wardPatientNotesActionButton;
