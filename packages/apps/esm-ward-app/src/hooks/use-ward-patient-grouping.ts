...
import { useAdmissionLocation } from './use-admission-location';
import { useInpatientAdmission } from './use-inpatient-admission';
import { useInpatientAdmissionByPatients } from './use-inpatient-admission-by-patients';
import { useInpatientRequest } from './use-inpatient-request';
import useWardLocation from './use-ward-location';
