...
function AllergyFormWorkspace(props: AllergyWorkspaceProps) {
  ...
  useEffect(() => {
    if (!formValuesLoadedRef.current && !isLoadingReactions && inEditMode) {
      ...
      setValue('allergen', defaultValues.allergen);
      setValue('nonCodedAllergen', defaultValues.nonCodedAllergen);
      setValue('allergicReactions', defaultValues.allergicReactions);
      setValue('nonCodedAllergicReaction', defaultValues.nonCodedAllergicReaction);
      setValue('severityOfWorstReaction', defaultValues.severityOfWorstReaction);
  ...
  const onSubmit = useCallback(
    ...
    [allergy?.id, createAllergyPayload, inEditMode, mutate, patientUuid, props, t],
  );
    ...
    >
      <Form className={styles.formContainer} onSubmit={handleFormSubmit}>
        ...
        <div className={styles.form}>
          ...
          >
            <Button className={styles.button} onClick={handleDiscard} kind="secondary">
              {t('discard', 'Discard')}
            </Button>
            <Button
