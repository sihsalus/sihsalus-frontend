...
### Login to **OpenMRS 2.x**

Use the local development account configured when the Docker environment was
created. Do not reuse documented, shared, production, or personal credentials.
...
Use the dedicated local development account configured for the Docker
environment. Store its credentials outside the repository.
...
- **User**: your dedicated local Orthanc user
- **Password**: a local secret stored outside the repository
