...
| CRED                 | [Estado, pruebas y pendientes clínicos](https://github.com/sihsalus/sihsalus-content/blob/main/docs/contracts/cred-clinical-completion.md), [integración del frontend](../../packages/apps/esm-crecimiento-desarrollo-app/README.md), [auditoría histórica NTS 238 (julio)](cred/NTS-238-AUDIT.md), [Test Peruano](test-peruano/README.md) |
