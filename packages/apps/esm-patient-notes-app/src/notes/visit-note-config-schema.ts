...
export default {
  ...
  biologicalFunctionsConceptUuid: {
    ...
    _description:
      "Summary of biological functions saved by visit notes with formFieldPath biological-functions",
  },
  appetiteConceptUuid: {
    _type: Type.ConceptUuid,
  ...
  referralConceptUuid: {
    ...
    _description:
      "Referral / interconsultation concept used by outpatient forms",
  },
