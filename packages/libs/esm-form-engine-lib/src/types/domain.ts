import { type OpenmrsResource, type UploadedFile } from '@openmrs/esm-framework/src/internal';
...
export interface OpenmrsEncounter {
  ...
  encounterProviders?: Array<{
    provider: OpenmrsResource | string;
    encounterRole: OpenmrsResource | string;
  }>;
  form?: OpenmrsFormResource;
  diagnoses?: Array<Diagnosis | DiagnosisPayload>;
}

export interface OpenmrsObs extends OpenmrsResource {
  concept?: OpenmrsResource | { uuid?: string; display?: string } | string;
