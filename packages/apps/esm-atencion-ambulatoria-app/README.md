...
Las entradas de Historia Social verifican la publicación y el tipo del formulario configurado antes de abrir el workspace compartido; si no pueden verificarlo, muestran un mensaje y conservan el formulario de origen. La tabla conserva sus columnas y datos, pero identifica los conceptos predeterminados según su significado real: cigarrillos por día, duración del tabaquismo en años y estado de consumo de tabaco. Los nombres heredados de configuración permanecen compatibles con overrides institucionales. El [contrato de Historia Social](../../../docs/clinical/social-history-content-contract.md) documenta el formulario ausente, el tipo de encuentro incompatible y las respuestas pendientes en content; la comprobación de apertura no subsana esos faltantes.
