...
import { mockQueueRooms, mockQueues, mockSession } from 'test-utils';
...
describe('service queue administration action menus', () => {
  ...
  it('does not expose queue administration actions without edit access', () => {
    ...
    render(
      <>
        <QueueActionMenu queue={mockQueues[0]} />
        <QueueRoomActionMenu queueRoom={mockQueueRooms.data.results[0]} />
      </>,
    );
