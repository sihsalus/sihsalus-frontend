...
```sh
yarn playwright test -c e2e/patient-imaging/playwright.config.ts --headed
```
...
```sh
yarn playwright test -c e2e/patient-imaging/playwright.config.ts --headed -g "title of the test"
```
