...
export default {
  ...
  therapeuticIndicationsConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.therapeuticIndicationsConceptUuid,
    _description: 'Free-text non-pharmacological instructions for the outpatient treatment plan',
  },
