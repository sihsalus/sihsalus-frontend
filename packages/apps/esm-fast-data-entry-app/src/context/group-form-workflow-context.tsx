...
import useGetSystemSetting from '../hooks/use-get-system-setting';
import reducer from './group-form-workflow-reducer';
...
const initialActions = {
  setGroup: (_group: GroupType) => undefined,
  unsetGroup: () => undefined,
  setSessionMeta: (_meta: MetaType) => undefined,
  ...
  updateVisitUuid: (_visitUuid: string) => undefined,
  submitForNext: (_nextPatientUuid: string = null) => undefined,
  submitForReview: () => undefined,
  submitForComplete: () => undefined,
  addPatientUuid: (_patientUuid: string) => undefined,
  removePatientUuid: (_patientUuid: string) => undefined,
