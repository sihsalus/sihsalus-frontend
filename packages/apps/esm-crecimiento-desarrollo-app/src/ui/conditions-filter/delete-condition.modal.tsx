...
const DeleteConditionModal: React.FC<DeleteConditionModalProps> = ({ closeDeleteModal, conditionId, patientUuid }) => {
  ...
  const canEditAntecedents = userHasAccess(credAntecedentsEditPrivilege, session?.user);
  ...
  const { isDeleting, isDeleted, isUncertain, handleDelete, handleClose } = useConditionDeletion({
    ...
    canDelete: canEditAntecedents && !reasonInvalid,
    onSuccess: () =>
      showSnackbar({
        isLowContrast: true,
        kind: 'success',
    ...
    onDeleteError: (error) =>
      showSnackbar({
        ...
        subtitle: getUserFacingErrorMessage(
          ...
          { logContext: 'Delete CRED condition' },
        ),
      }),
    onRefreshError: (error) =>
      showSnackbar({
        ...
        subtitle: getUserFacingErrorMessage(
          ...
          { logContext: 'Delete CRED condition refresh' },
        ),
      }),
  });
