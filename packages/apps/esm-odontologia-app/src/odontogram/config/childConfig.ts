...
/**
 * Primary tooth order and zones recovered from Mauricio Arenales' delivery:
 * MauArenales/react-odontogram-v2, mauricio@bc00f0fa6d6120fdc3d493737ff57fbd1f7dd9ab.
 * Root silhouettes follow the NTS 188-MINSA/DGIESP-2022 annex (page 22).
...
const upper: ToothConfig[] = [
  ...
  { id: 54, position: 'upper', type: 'molar', zones: 8, rootDesign: 'default' },
  ...
  { id: 64, position: 'upper', type: 'molar', zones: 8, rootDesign: 'default' },
  { id: 65, position: 'upper', type: 'molar', zones: 8, rootDesign: 'default' },
];

const lower: ToothConfig[] = [
  { id: 85, position: 'lower', type: 'molar', zones: 8, rootDesign: 'twoRoots' },
  ...
  { id: 75, position: 'lower', type: 'molar', zones: 8, rootDesign: 'twoRoots' },
];
