...
import { useClinicalHistoryPagination } from './use-clinical-history-pagination';
import { useReferralCounterReferral } from './use-referral-counter-referral';

vi.mock('./use-clinical-history-pagination', () => ({
