import { getDefaultsFromConfigSchema, showSnackbar, useConfig, type Visit } from '@openmrs/esm-framework';
import { render, screen, waitFor } from '@testing-library/react';
import userEvent from '@testing-library/user-event';
import { beforeEach, describe, expect, it, vi } from 'vitest';
import { type Config, configSchema } from '../config-schema';
import AddTaskForm from './add-task-form.component';
import { saveTask, type Task, updateTask, useFetchProviders, useProviderRoles, useTask } from './task-list.resource';
...
describe('AddTaskForm', () => {
  ...
  beforeEach(() => {
    ...
    mockSaveTask.mockResolvedValue({} as Awaited<ReturnType<typeof saveTask>>);
    mockUpdateTask.mockResolvedValue({} as Awaited<ReturnType<typeof updateTask>>);
  });
