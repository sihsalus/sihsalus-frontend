...
export default {
  clinicianEncounterRole: {
    ...
    _description:
      "Doctor or Nurse who is the primary provider for an encounter, and will sign the note",
  },
  visitDiagnosesConceptUuid: {
    _type: Type.ConceptUuid,
    _default: "159947AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
    _description:
      "The set of diagnoses that were either addressed or diagnosed during the current visit",
  },
  encounterNoteTextConceptUuid: {
    _type: Type.ConceptUuid,
    _default: "162169AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
    _description:
      "Free text note field intended to capture unstructured description of the patient encounter",
  },
  ...
  chiefComplaintConceptUuid: {
    ...
    _description:
      "Chief complaint / motive for consultation, reused from anamnesis when available",
  },
  illnessDurationConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.illnessDurationConceptUuid,
    _description:
      "Duration of current illness, reused from anamnesis when available",
  },
  anamnesisConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.anamnesisConceptUuid,
    _description:
      "Chronological illness story / anamnesis concept used as fallback source for subjective notes",
  },
  biologicalFunctionsConceptUuid: {
    ...
    _description:
      "Read-only summary of biological functions loaded from outpatient encounters with formFieldPath biological-functions",
  },
  appetiteConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.appetiteConceptUuid,
    _description:
      "Appetite biological function concept used to prefill visit notes",
  },
  thirstConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.thirstConceptUuid,
    _description:
      "Thirst biological function concept used to prefill visit notes",
  },
  sleepConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.sleepConceptUuid,
    _description:
      "Sleep biological function concept used to prefill visit notes",
  },
  moodConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.moodConceptUuid,
    _description:
      "Mood biological function concept used to prefill visit notes",
  },
  urineConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.urineConceptUuid,
    _description:
      "Urine biological function concept used to prefill visit notes",
  },
  bowelMovementsConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.bowelMovementsConceptUuid,
    _description:
      "Bowel movements biological function concept used to prefill visit notes",
  },
  ...
  soapObjectiveConceptUuid: {
    ...
    _description:
      "SOAP objective / physical exam concept used by outpatient forms",
  },
  ...
  labOrdersConceptUuid: {
    ...
    _description:
      "Text question used to persist auxiliary exams / laboratory orders from outpatient forms",
  },
  ...
  prescriptionsConceptUuid: {
    ...
    _description:
      "Text question used to persist prescription instructions from outpatient forms",
  },
  referralConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.referralConceptUuid,
    _description:
      "Referral / counter-referral concept read from outpatient encounters; interconsultations remain dedicated orders",
  },
  nextAppointmentConceptUuid: {
    _type: Type.ConceptUuid,
    _default: defaultVisitNoteClinicalConceptUuids.nextAppointmentConceptUuid,
    _description:
      "Date question used to persist the next appointment as an OpenMRS Date observation",
  },
  encounterTypeUuid: {
    _type: Type.UUID,
  ...
  diagnosisTypeConceptUuid: {
    ...
    _description:
      "UUID del concepto Tipo de diagnóstico (NTS-139). Respuestas: Presuntivo, Definitivo, Repetitivo",
  },
  diagnosisTypePresuntivoUuid: {
    _type: Type.UUID,
    _default: "4f59cf03-f888-4d34-a5dc-f24269b1945d",
    _description:
      "UUID de la respuesta Presuntivo (P) del concepto Tipo de diagnóstico",
  },
  diagnosisTypeDefinitivoUuid: {
    _type: Type.UUID,
    _default: "2c60a8f6-1787-41be-8434-30ebeb5656ff",
    _description:
      "UUID de la respuesta Definitivo (D) del concepto Tipo de diagnóstico",
  },
  diagnosisTypeRepetitivoUuid: {
    _type: Type.UUID,
    _default: "6f653861-8469-4dfa-a0b5-2804f1cfc527",
    _description:
      "UUID de la respuesta Repetitivo (R) del concepto Tipo de diagnóstico",
  },
};
