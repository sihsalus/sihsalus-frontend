...
interface FormFactoryProviderProps {
  ...
  formSubmissionProps: {
    ...
    onError?: (error: Error | SnackbarDescriptor) => void;
    handleClose: () => void;
    handleOnValidate?: (valid: boolean) => void;
  };
...
export const FormFactoryProvider: React.FC<FormFactoryProviderProps> = ({
  ...
  const { isSubmitting, setIsSubmitting, onSubmit, onError, handleClose, handleOnValidate } = formSubmissionProps;
...
export const useFormFactory = (): FormFactoryProviderContextProps => {
