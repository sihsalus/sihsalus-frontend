import { Checkbox, Layer, Tag, Tile } from '@carbon/react';
import { EmptyCardIllustration, showSnackbar, useLayoutType } from '@openmrs/esm-framework';
import classNames from 'classnames';
import React, { useCallback, useState } from 'react';
import { useTranslation } from 'react-i18next';
import Loader from '../loader/loader.component';
import { getPriorityLabel, setTaskStatusCompleted, type Task, useTaskList } from './task-list.resource';
        ...
        return (
          <li key={task.uuid}>
            ...
            >
              ...
              <button type="button" onClick={() => onTaskClick?.(task)} className={styles.taskTileContentButton}>
