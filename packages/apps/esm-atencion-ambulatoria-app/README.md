...
La cabecera ofrece además **Imprimir indicaciones**, una hoja PDF breve para entregar al paciente. Incluye la identificación institucional configurada (ubicación, teléfono y código IPRESS), identificación del paciente, fecha y responsable de la atención, la próxima cita programada verificable, indicaciones terapéuticas, medicamentos indicados mediante órdenes no anuladas, sustituidas, suspendidas ni vencidas registradas en la visita, la fecha de control indicada y un espacio para la firma y el sello manuscritos del profesional responsable. Las órdenes canónicas tienen prioridad; el texto histórico de prescripción se usa únicamente cuando la visita no contiene órdenes canónicas, para evitar duplicados. La hoja debe ser revisada, firmada y sellada antes de entregarse al paciente; sigue siendo informativa y no sustituye una receta médica o electrónica válida para dispensación.
