...
import PatientLocationMismatchModal from '../form-entry-workflow/patient-search-header/patien-mismatched-location-modal';
    ...
    >
      ...
      {!errors?.patientList && (
        <ul className={styles.patientList}>
          {patientList?.map((patient, _index) => (
...
const AddGroupModal = ({
  ...
  }, [selectedPatientUuid, patientList]);
