...
export const PatientBannerPatientInfo = jest.fn(({ patient }) => (
  <div>{patient ? utils.getPatientName(patient) : 'Patient Banner Patient Info'}</div>
));
...
export const ActionMenuButton = jest.fn(({ handler }) => (
