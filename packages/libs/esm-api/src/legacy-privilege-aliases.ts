...
const renamedPrivilegePairs = [
  ...
  ['app:hoja.clinica.citas.editar.finalizarAtencion', 'app:clinical.chart.appointments.edit.finalizeCare'],
  ...
  ['app:home.citas.editar.finalizarAtencion', 'app:appointments.edit.finalizeCare'],
